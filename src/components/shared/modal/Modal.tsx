...
export default function Modal({
  ...
  return createPortal(
    <div
      ...
      } fixed z-50 left-1/2 bottom-0 transform -translate-x-1/2 transition duration-700 ease-out min-w-[312px] max-w-[368px] tab:max-w-[496px] laptop:tab:max-w-[950px]
