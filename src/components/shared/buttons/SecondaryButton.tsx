...
export default function SecondaryButton({
  ...
  return (
    <button
      ...
      type={type}
      onClick={onClick}
      className={`flex items-center justify-center w-fit p-2 laptop:py-5 laptop:px-[25px] text-12med laptop:text-18med deskxl:text-24bold rounded-full text-white bg-black 
