...
export default function Button({
  ...
  return (
    <button
      ...
      disabled={disabled}
      onClick={onClick}
      className={`flex items-center justify-center w-full max-w-[350px] deskxl:max-w-[437px] deskxl:w-[437px] h-[54px] laptop:h-[82px] deskxl:h-[85px] px-3 text-14bold laptop:text-18bold 
