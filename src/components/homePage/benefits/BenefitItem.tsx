...
export default function BenefitItem({ benefitItem }: BenefitItemProps) {
  ...
  return (
    <li className="flex flex-col justify-center w-[48.5%] laptop:w-full px-[18px] py-[25px] laptop:p-[30px] desk:p-[50px] rounded-[15px] laptop:rounded-[30px] bg-yellowGradient">
      ...
      />
      <h3 className="w-[140px] desk:max-w-[174px] mb-2 laptop:mb-4 text-12semi laptop:text-20semi desk:text-24semi">
        {title}
      </h3>
      <p className="w-[134px] tab:w-[235px] tabxl:w-[179px] desk:w-[229px] text-12med laptop:text-14med desk:text-18med">
        {description}
      </p>
    </li>
  );
