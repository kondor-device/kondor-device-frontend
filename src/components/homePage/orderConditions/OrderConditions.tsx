...
export default function OrderConditions() {
  ...
  return (
    <Section
      id="delivery"
      className="flex flex-col gap-y-5 laptop:flex-row-reverse laptop:gap-x-[69px] laptop:justify-center"
    >
      ...
      <Image
        ...
        width="1377"
        height="1405"
        className="w-full laptop:w-[547px] desk:w-[688px] h-auto aspect-[1377/1405]"
      />
    </Section>
  );
}
