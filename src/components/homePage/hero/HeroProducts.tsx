...
export default async function HeroProducts({
  ...
  return (
    <ul className="flex flex-wrap justify-center gap-2 mob:gap-[10px] sm:gap-[16px] deskxl:gap-6 laptop:w-[49%] desk:w-[42%] deskxl:w-[54.5%] max-w-[704px] laptop:max-w-full my-[30px] laptop:my-auto mx-auto deskxl:mr-0">
