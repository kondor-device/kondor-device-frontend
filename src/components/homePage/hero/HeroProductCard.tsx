...
export default function HeroProductCard({ product }: HeroProductCardProps) {
  ...
  return (
    ...
    >
      <div className="flex items-center justify-center w-full tab:w-[85%] laptop:w-[65%] deskxl:size-[90%] aspect-[1/1] mx-auto my-auto">
        <Link
      ...
      <h2 className="mt-auto mb-[11px] desk:mb-[15px] deskxl:mb-[25px] text-12bold mob:text-14bold sm:text-20bold deskxl:text-28bold text-center">
        {name}
      </h2>
      <Link
        href={cat?.name ? localizedCategoryLink : localizedCatalogLink}
