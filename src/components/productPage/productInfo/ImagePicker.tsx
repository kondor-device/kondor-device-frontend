...
export default function ImagePicker({ photos }: ImagePickerProps) {
  ...
  return (
    <>
      <div className="gallery-container w-full max-w-[380px] tab:max-w-[514px] tabxl:max-w-[617px] tabxl:w-[calc(50%-40px)] desk:w-[calc(50%-60px)] mx-auto tabxl:mx-0 mb-8 tabxl:mb-0 scroll-mt-[142px] tabxl:scroll-mt-[173px]">
        <ImageGallery
          ref={(ref) => {
